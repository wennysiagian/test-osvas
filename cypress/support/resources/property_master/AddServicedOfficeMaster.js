Cypress.Commands.add("addServicedoffice", (Id, Name, State, City, District, Village, Tower, Floor, Unit, Pax, Grade, Developer, Completion,Management, Lokasi) => {
    cy
