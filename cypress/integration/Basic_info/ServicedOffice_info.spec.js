import "../../support/resources/property_master/AddServicedOfficeMaster.js"
...
context('Basic Info Validation Test', () => {
    ...
    it('Create serviced office Success', () => {
        ...
        cy.addServicedoffice(Id, Name, State, City, District, Village, Tower, Floor, Unit, Pax, Grade, Developer, Completion, Management, Lokasi)
        cy.wait(3000)
